...
##OFICE
    ...
    def st_officeon(self, speech, language):
    	...
    	self.system ("java -jar '/home/ubuntu/SiriProxy/KNX/_Office__Turn_Light_ON.jar'")
    ...
    def st_officeoff(self, speech, language):
    	...
    	self.system ("java -jar '/home/ubuntu/SiriProxy/KNX/_Office__Turn_Light_OFF.jar'")
    	self.complete_request()
...
##KITCHEN
    ...
    def st_kitchenon(self, speech, language):
        ...
        self.system ("java -jar '/home/ubuntu/SiriProxy/KNX/_Kitchen__Turn_Light_ON_1.jar'")
    ...
    def st_kitchenoff(self, speech, language):
        ...
        self.system ("java -jar '/home/ubuntu/SiriProxy/KNX/_Kitchen__Turn_Light_OFF_1.jar'")
        self.system ("java -jar '/home/ubuntu/SiriProxy/KNX/_Kitchen__Turn_Light_OFF_2.jar'")
        self.complete_request()