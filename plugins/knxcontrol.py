...
##OFICE
    ...
    @register("pt-BR", "(.*escritório.*ligar.*)|(.*ligar.*escritório.*)|(.*escritorio.*ligue.*)|(.*ligue.*escritorio.*))|(.*ligar.*estudos.*)|(.*ligue.*estudos.*)")
    ...
    @register("pt-BR", "(.*escritorio.*desligar.*)|(.*desligar.*escritorio.*)|(.*escritorio.*desligue.*)|(.*desligue.*escritorio.*)|(.*desligar.*estudos.*)|(.*desligue.*estudos.*)")
