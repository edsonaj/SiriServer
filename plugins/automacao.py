...
@register("pt-BR", "(.*cozinha.*ligar.*)|(.*ligar.*cozinha.*)|(.*cozinha.*ligue.*)|(.*ligue.*cozinha.*)|(.*cozinha.*liga.*)|(.*liga.*cozinha.*)")
...
@register("pt-BR", "(.*cozinha.*desligar.*)|(.*desligar.*cozinha.*)|(.*cozinha.*desligue.*)|(.*desligue.*cozinha.*)|(.*cozinha.*desliga.*)|(.*desliga.*cozinha.*)")
...
@register("pt-BR", "(.*escritório.*ligar.*)|(.*ligar.*escritório.*)|(.*escritório.*ligue.*)|(.*ligue.*escritório.*)|(.*escritório.*liga.*)|(.*liga.*escritório.*)")
...
@register("pt-BR", "(.*escritório.*desligar.*)|(.*desligar.*escritório.*)|(.*escritório.*desligue.*)|(.*desligue.*escritório.*)")
